...
This project is indexed by GitNexus as **careflow** (1581 symbols, 3142 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
