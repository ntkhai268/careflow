...
This project is indexed by GitNexus as **careflow** (5673 symbols, 13022 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
