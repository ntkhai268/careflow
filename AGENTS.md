...
This project is indexed by GitNexus as **careflow** (1938 symbols, 3881 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
