...
This project is indexed by GitNexus as **careflow** (4498 symbols, 10343 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
