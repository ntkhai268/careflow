...
This project is indexed by GitNexus as **careflow** (5323 symbols, 12309 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
