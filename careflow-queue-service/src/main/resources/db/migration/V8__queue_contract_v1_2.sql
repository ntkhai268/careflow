ALTER TABLE queue.queue_entries
    ADD COLUMN queue_type VARCHAR(30) NOT NULL DEFAULT 'CONSULTATION',
    ADD COLUMN consultation_phase VARCHAR(30),
    ADD COLUMN queue_class VARCHAR(20),
    ADD COLUMN service_point_id VARCHAR(80),
...
ALTER TABLE queue.queue_configs
    ADD COLUMN last_served_lane VARCHAR(30);
...
CREATE UNIQUE INDEX uk_queue_active_initial_consultation
...
CREATE UNIQUE INDEX uk_queue_active_result_review
