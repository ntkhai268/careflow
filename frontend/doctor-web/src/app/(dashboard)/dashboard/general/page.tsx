    ...
    async function loadDashboardData() {
      ...
      try {
        ...
        try {
          ...
          const waitingAppts = appts.filter(a => a.status === "CONFIRMED" || a.status === "PENDING" || a.status === "WAITING");
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <Link href="/dashboard/queue"
              className="text-[11px] font-semibold text-indigo-500 hover:text-indigo-700 transition-colors flex items-center gap-1">
              Xem tất cả
