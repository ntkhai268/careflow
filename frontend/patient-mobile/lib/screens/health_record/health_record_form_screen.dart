            ...
            ExpansionTile(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Tiêu đề*',
                    hintText: 'Ví dụ: Khám mắt, tầm soát ung thư',
                    border: OutlineInputBorder(),
                  ),
                ...
                TextFormField(
                  ...
                  onTap: _selectDate,
                  validator: (val) =>
                      val == null || val.isEmpty ? 'Vui lòng chọn ngày' : null,
                ),
                const SizedBox(height: 16),
                TextFormField(
                  controller: _facilityController,
                  decoration: const InputDecoration(
                    labelText: 'Tên cơ sở y tế*',
                    hintText: 'Nhập cơ sở y tế',
                    border: OutlineInputBorder(),
                  ),
                  validator: (val) => val == null || val.isEmpty
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Ghi chú',
                    hintText: 'Ghi chú chung cho đợt khám',
                    border: OutlineInputBorder(),
                  ),
                  maxLines: 3,
                ),
                ...
                const SizedBox(height: 8),
                const Text(
                  '*Ghi chú: Định dạng .png, .jpg, .doc, .docx, .pdf',
